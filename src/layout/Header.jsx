  ...
  return (
    ...
    <div id="header" class="app-header">
      ...
      <div class="navbar-header">
        <a href="home" class="navbar-brand rounded-pill text-white"><img src="./assets/img/logo/bp-shop.png" className='rounded-pill' alt="" /> <b class="ms-2 me-1 text-white">PB</b> Apartment</a>
