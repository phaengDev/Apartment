...
const handleSubmit = async (event) => {
    ...
    try {
      ...
      if (res.status === 200) {
        const { username, userEmail, staffCode, staff_id, token, buildingId } = res.data; 
                ...
                <div class="login-container rounded-3 border-4 border-top border-gold rounded-top-4 border-bps pt-4 bg-white">
                    ...
                    <div class="login-content">
                        <form  onSubmit={handleSubmit}>
                            ...
                            <div class="form-floating mb-20px">
                                <input type={showPassword ? 'text' : 'password'} onChange={(e)=>handledChange('userPassword',e.target.value)} class="form-control fs-13px h-45px border-blue" placeholder="Password" required />
